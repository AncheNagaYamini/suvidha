...
public class FilterByDistrict extends AppCompatActivity implements ListView.OnItemClickListener,View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filter_by_district);
    ...
    private void getDistricts(JSONArray j){
        ...
        spinner.setAdapter(new ArrayAdapter<String>(FilterByDistrict.this, android.R.layout.simple_spinner_dropdown_item, districts));
    ...
    private void getMandals(JSONArray j){
        ...
        //Setting adapter to show the items in the spinner
        spinner2.setAdapter(new ArrayAdapter<String>(FilterByDistrict.this, android.R.layout.simple_spinner_dropdown_item, mandals));
    ...
    private void getVillages(JSONArray j){
        ...
        //Setting adapter to show the items in the spinner
        spinner3.setAdapter(new ArrayAdapter<String>(FilterByDistrict.this, android.R.layout.simple_spinner_dropdown_item, villages));
    ...
    private void showEmployee(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                FilterByDistrict.this, list, R.layout.list_item,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(FilterByDistrict.this,"Fetching Data","Wait...",false,false);
            }
    ...
    private void getJSONFilter(){
        ...
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequest("https://pro10997.000webhostapp.com/RuralPro/rural/Filter/getAllProbFiltDist.php?d="+district_name);
                return s;
            }
        }
        GetJSON gj = new GetJSON();
